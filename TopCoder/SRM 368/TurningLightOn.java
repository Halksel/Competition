...
// CUT begin
	public static void main(String[] args){
		System.err.println("TurningLightOn (500 Points)");
		System.err.println();
	...
	static void runTest(HashSet<Integer> caseSet) {
        ...
        int T = (int)(System.currentTimeMillis() / 1000) - 1487576135;
	...
	static boolean doTest(String[] board, int __expected) {
		...
		int __result = 0;
		try {
			__result = instance.minFlips(board);
		}
	...
	static class Reader {
        private static final String dataFileName = "TurningLightOn.sample";
